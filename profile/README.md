...
**Open-source arcade frontend for Windows — built with Rust, Tauri & React.**

KairoOS turns any PC into a fully-featured arcade station.  
Gamepad-first, plugin-powered, fully customizable.
...
- **Plugin** → open a PR in [kairos-plugins/community/](https://github.com/KairoOS/kairos-plugins)
- **Theme** → open a PR in [kairos-themes/community/](https://github.com/KairoOS/kairos-themes)
